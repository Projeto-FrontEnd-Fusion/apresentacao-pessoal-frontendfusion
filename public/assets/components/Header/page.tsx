...
function Header() {
  return (
    <section className="container_header flex items-center justify-center fixed top-1 left-3 border h-[10vh] backdrop-blur-lg rounded-lg" role="banner" data-aos="zoom-out">
      {/* Logo */}
